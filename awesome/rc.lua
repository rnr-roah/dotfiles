...
tyrannical.tags = {
  ...
  
  {
    ...
    class ={
      "Kate", "codium", "Code", "Code::Blocks" , "DDD", "kate4"}
  } ,
  {
    name = "Files -4",
    init        = true,
  ...
  
  {
    ...
    class  = {
      "VirtualBox", "virtualbox", "VirtualBox Manager", "virtualbox manager", "VirtualBoxVM", "+VirtualBoxVM", "scrcpy"
    }
  } ,
...
---- Start of Customized
  ...
  awful.key({ modkey, "Shift"   }, "c", function () awful.spawn("scrcpy") end,
    ...
    {description = "open shutdown", group = "Customized launchers"}),
    {description = "open wifi manager", group = "Customized launchers"}),
  awful.key({ modkey,           }, "i", function () awful.spawn("alacritty -e ./scripts/wifi.sh") end,
    {description = "connect wifi", group = "Customized launchers"}),
